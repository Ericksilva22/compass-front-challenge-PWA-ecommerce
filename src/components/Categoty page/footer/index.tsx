...
import { Footer_content, DivMore, H2_more, Img_more_up, Section_mobile, Img_more_down, ShopCategory, Footer_title, Footer_links, DivLogos, DivLocation, Img_Logos } from './footer'
